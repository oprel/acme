...
#ifdef ACME
/* Updated conversion table for converting between Japanese lunisolar and Gregorian to support up until 2099 */
static lbRk_date_t l_lbRk_ConvertTable[lbRk_YEAR_NUM][lbRk_KYUU_LEAP_MONTH] = {
  ...
  /* 2033 */ {{1, 31}, {3,  1}, {3, 31}, {4, 29}, {5, 28}, {6, 27}, {7, 26}, {8, 25}, { 9, 23}, {10, 23}, {11, 22}, { 1, 20}, { 0,  0}},
  ...
  /* 2042 */ {{1, 22}, {2, 20}, {3, 22}, {5, 19}, {6, 18}, {7, 17}, {8, 16}, {9, 14}, {10, 14}, {11, 13}, {12, 12}, { 1, 11}, { 4, 20}},
  ...
  /* 2047 */ {{1, 26}, {2, 25}, {3, 26}, {4, 25}, {5, 25}, {6, 23}, {8, 21}, {9, 20}, {10, 19}, {11, 17}, {12, 17}, { 1, 15}, { 7, 23}},
  ...
  /* 2050 */ {{1, 23}, {2, 22}, {3, 23}, {4, 21}, {6, 19}, {7, 19}, {8, 17}, {9, 16}, {10, 16}, {11, 14}, {12, 14}, { 1, 13}, { 5, 21}},
  /* 2051 */ {{2, 11}, {3, 13}, {4, 11}, {5, 10}, {6,  9}, {7,  8}, {8,  7}, {9,  5}, {10,  5}, {11,  4}, {12,  3}, { 1,  2}, { 0,  0}},
  ...
  /* 2074 */ {{1, 27}, {2, 26}, {3, 27}, {4, 26}, {5, 26}, {6, 24}, {8, 23}, {9, 21}, {10, 20}, {11, 19}, {12, 18}, { 1, 17}, { 7, 24}},
  ...
  /* 2090 */ {{1, 30}, {3,  1}, {3, 31}, {4, 30}, {5, 29}, {6, 28}, {7, 27}, {8, 25}, { 9, 24}, {11, 21}, {12, 21}, { 1, 20}, {10, 23}},
  ...
  /* 2096 */ {{1, 25}, {2, 24}, {3, 24}, {4, 23}, {5, 22}, {7, 20}, {8, 18}, {9, 17}, {10, 16}, {11, 15}, {12, 15}, { 1, 14}, { 6, 20}},
...
static int l_lbRk_leapdays[lbRk_YEAR_NUM] = {
   0, 29,  0,  0, 29,  0, 29,  0,  0, 29,  0,  0, /* 2000-2011 */
  30,  0, 29,  0,  0, 29,  0,  0, 29,  0,  0, 30, /* 2012-2023 */
   0, 29,  0,  0, 29,  0,  0, 30,  0,  0,  0,  0, /* 2024-2035 */
  29,  0,  0, 30,  0,  0, 29,  0, 29,  0,  0, 29, /* 2036-2047 */
   0,  0, 29,  0, 30,  0,  0, 29,  0,  0, 30,  0, /* 2048-2059 */
   0, 29,  0, 29,  0,  0, 30,  0,  0, 29,  0, 29, /* 2060-2071 */
   0,  0, 29,  0,  0, 29,  0,  0, 29,  0, 29,  0, /* 2072-2083 */
   0, 30,  0,  0, 29,  0, 29,  0,  0, 30,  0,  0, /* 2084-2095 */
  29,  0,  0, 30,                                 /* 2096-2099 */
};
#else
...
#ifdef ACME
  /* Extended table of Harvest Moon dates for support up until 2099 */
  static lbRk_date_t ev_day[lbRk_HARVEST_MOON_YEAR_NUM] = {
    /* 2002 */ { 9, 21}, /* 2003 */ { 9, 11}, /* 2004 */ { 9, 28}, /* 2005 */ { 9, 18},
    /* 2006 */ {10,  6}, /* 2007 */ { 9, 25}, /* 2008 */ { 9, 14}, /* 2009 */ {10,  3},
    /* 2010 */ { 9, 22}, /* 2011 */ { 9, 12}, /* 2012 */ { 9, 30}, /* 2013 */ { 9, 19},
    /* 2014 */ { 9,  8}, /* 2015 */ { 9, 27}, /* 2016 */ { 9, 15}, /* 2017 */ {10,  4},
    ...
    /* 2034 */ { 9, 27}, /* 2035 */ { 9, 16}, /* 2036 */ {10,  4}, /* 2037 */ { 9, 24},
    /* 2038 */ { 9, 13}, /* 2039 */ {10,  2}, /* 2040 */ { 9, 21}, /* 2041 */ { 9, 10},
    /* 2042 */ { 9, 28}, /* 2043 */ { 9, 17}, /* 2044 */ {10,  5}, /* 2045 */ { 9, 25},
    /* 2046 */ { 9, 15}, /* 2047 */ {10,  4}, /* 2048 */ { 9, 22}, /* 2049 */ { 9, 11},
    /* 2050 */ { 9, 30}, /* 2051 */ { 9, 19}, /* 2052 */ { 9,  7}, /* 2053 */ { 9, 26},
    /* 2054 */ { 9, 16}, /* 2055 */ {10,  5}, /* 2056 */ { 9, 24}, /* 2057 */ { 9, 13},
    /* 2058 */ {10,  2}, /* 2059 */ { 9, 21}, /* 2060 */ { 9,  9}, /* 2061 */ { 9, 28},
    /* 2062 */ { 9, 17}, /* 2063 */ {10,  6}, /* 2064 */ { 9, 25}, /* 2065 */ { 9, 15},
    /* 2066 */ {10,  3}, /* 2067 */ { 9, 23}, /* 2068 */ { 9, 11}, /* 2069 */ { 9, 29},
    /* 2070 */ { 9, 19}, /* 2071 */ { 9,  8}, /* 2072 */ { 9, 26}, /* 2073 */ { 9, 16},
    /* 2074 */ {10,  5}, /* 2075 */ { 9, 24}, /* 2076 */ { 9, 12}, /* 2077 */ {10,  1},
    /* 2078 */ { 9, 20}, /* 2079 */ { 9, 10}, /* 2080 */ { 9, 28}, /* 2081 */ { 9, 17},
    /* 2082 */ {10,  6}, /* 2083 */ { 9, 26}, /* 2084 */ { 9, 14}, /* 2085 */ {10,  3},
    /* 2086 */ { 9, 22}, /* 2087 */ { 9, 11}, /* 2088 */ { 9, 29}, /* 2089 */ { 9, 19},
    /* 2090 */ { 9,  8}, /* 2091 */ { 9, 27}, /* 2092 */ { 9, 16}, /* 2093 */ {10,  5},
    /* 2094 */ { 9, 24}, /* 2095 */ { 9, 13}, /* 2096 */ {10,  1}, /* 2097 */ { 9, 20},
    /* 2098 */ { 9, 10}, /* 2099 */ { 9, 29},
  };
#else
  static lbRk_date_t ev_day[lbRk_HARVEST_MOON_YEAR_NUM] = {
