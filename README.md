# Animal Crossing: Minimally Enhanced

ACME is a quality of life mod for Animal Crossing for the Nintendo GameCube. It stays as close to vanilla as possible, just smoothing out interactions slighty with UI conveniences and making all available content accessible to the player.
...
- Speed up/automatically continue text with L/R.
- Previously seen text can be sped through slightly faster (skips set pauses in dialogue).
...
- Slightly easier to clean Gracie's car.
